...
explaining it is [phase 3b](phase-3b-verifying.md).

### 7. Pre-commit Security
...
[phase 7a §16](phase-7a-running-a-review.md) turned around: the same obligation, owed by
...
- **Never self-modify** security boundaries, auth logic, secret handling, or the pre-commit
  hooks in §7. A broken guardrail is not a bug to route around.
