...
Dry-run defaults ([phase 3a §7](phase-3a-writing-resilient-code.md)) do not cover this.
...
[Phase 3b §8](phase-3b-verifying.md) says temp dirs and mocked externals, which is not
...
the same predicate its report prints ([phase 3f §12](phase-3f-numbers-you-can-publish.md)),
and run it before and after anything that touches both. It is also what makes
[phase 8b §23](phase-8b-instrumentation.md)'s "believe the system's own health check"
